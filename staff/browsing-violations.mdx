...
<Steps>
  <Step title="Go to the violations page">
    Navigate to **readyrule.com/violations**. You will see the main index of all California childcare violations with 247 violation types tracked. Violations are organized by category:
