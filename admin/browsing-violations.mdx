...
<Steps>
  <Step title="Go to the violations index">
    Navigate to **readyrule.com/violations**. You will see the main violations library with 247 violation types tracked, organized by category (Staff & Supervision, Health & Safety, Physical Environment, Records & Documentation, Nutrition & Food Service).
  </Step>
